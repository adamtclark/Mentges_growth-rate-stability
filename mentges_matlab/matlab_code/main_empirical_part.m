...
ax1.YLabel.String = 'Recovery_{raw}';
ax1.YLim = [-0.5 3.5];
...
ax1.YLabel.String = 'Recovery_{corr}';
ax1.YLim = [-0.5 3.5];
lines =  findobj(gca,'Type','line');
l = legend(ax1, [lines(1) lines(2)], 'Median', 'Mean');
l.Position = [0.05 0.77 0.07 0.09];
